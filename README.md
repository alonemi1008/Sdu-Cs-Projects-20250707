...
本仓库包含六个完整的密码学项目，涵盖对称密码、哈希函数、椭圆曲线密码、数字水印、零知识证明和隐私保护技术。每个项目均包含详细的数学推导、算法分析和完整的实现代码。
...
### 1. SM4对称加密算法优化
- **实现方法**: 查表优化、SIMD指令集优化、AES-NI指令集优化
- **性能提升**: AES-NI实现相比基础版本提升10倍以上
- **应用场景**: 高性能数据加密、实时通信安全

### 2. 数字水印技术研究
- **算法实现**: LSB空域算法、DCT频域算法、DWT-DCT-SVD变换域算法
- **鲁棒性分析**: 抗噪声、抗压缩、抗裁剪能力测试
- **应用价值**: 数字版权保护、内容认证、隐蔽通信

### 3. 零知识证明系统
- **核心技术**: Groth16证明系统、Poseidon2哈希函数
- **创新点**: 高效电路设计、优化验证速度
- **应用场景**: 隐私保护计算、区块链应用

### 4. SM3哈希算法优化
- **优化方法**: SIMD并行计算、缓存友好设计
- **性能提升**: 批量处理模式下达到2.8倍加速
- **应用价值**: 高性能数据完整性校验、数字签名

### 5. SM2椭圆曲线密码实现
- **算法优化**: NAF算法、滑动窗口、蒙哥马利阶梯
- **性能提升**: 点乘法操作提升2.6倍以上
- **应用场景**: 高效数字签名、密钥交换

### 6. 隐私保护密码检测
- **核心技术**: PSI协议、椭圆曲线盲化、Argon2哈希
- **安全特性**: 零知识查询、K-匿名性保护
- **应用价值**: 安全密码泄露检测、隐私保护认证
...
本项目涵盖六大密码学方向的理论研究与实践实现：

1. **SM4对称加密算法**: 实现查表优化、SIMD指令集优化、AES-NI指令集优化三种加速方案，包含完整的数学推导和性能分析
2. **SM3哈希函数**: 基础版本和SIMD并行计算版本，提供详细的算法数学基础和压缩函数分析
3. **SM2椭圆曲线密码**: 完整ECC实现，包含NAF算法、滑动窗口、蒙哥马利阶梯等多种点乘法优化技术
4. **数字水印技术**: LSB空域、DCT频域、DWT-DCT-SVD变换域三种算法路线，涵盖数学原理和鲁棒性分析
5. **零知识证明系统**: 基于Groth16证明系统的Poseidon2哈希电路实现，包含完整的密码学理论基础
6. **隐私保护密码检测**: Google Password Checkup协议实现，涵盖PSI协议、椭圆曲线盲化、Argon2哈希等核心技术
